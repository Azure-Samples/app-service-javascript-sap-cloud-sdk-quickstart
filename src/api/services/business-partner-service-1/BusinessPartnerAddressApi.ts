...
> implements EntityApi<BusinessPartnerAddress<DeSerializersT>, DeSerializersT>
{
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      TO_EMAIL_ADDRESS: new Link('to_EmailAddress', this, linkedApis[1]),
      TO_FAX_NUMBER: new Link('to_FaxNumber', this, linkedApis[2]),
      TO_MOBILE_PHONE_NUMBER: new Link(
        'to_MobilePhoneNumber',
        this,
        linkedApis[3]
      ),
      TO_PHONE_NUMBER: new Link('to_PhoneNumber', this, linkedApis[4]),
      TO_URL_ADDRESS: new Link('to_URLAddress', this, linkedApis[5])
    };
    return this;
  }
